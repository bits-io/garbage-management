						...
						<div class="row">
							<div class="col-12 col-lg-8 m-auto">
								<div class="card">
									...
									<div class="card-body">
										<form action="<?= base_url($page_name.'/edit_process/'.$data[0]->id_jenis) ?>" method="post" class="multisteps-form__form" style="height: 330px;">
													...
													<div class="row mt-3">
														<div class="col-12">
															<div class="input-group input-group-static">
																...
																<input required value="<?= $data[0]->nama_jenis_sampah ?>" name="nama_jenis_sampah" placeholder="Nama Jenis Sampah" class="multisteps-form__input form-control" type="text" onfocus="focused(this)" onfocusout="defocused(this)"> </div>
														</div>
													</div>
