			...
			<div class="col-6 mx-auto">
				...
				<div class="card card-body mx-3 mx-md-4 mt-n6">
					...
					<div class="col-auto my-auto">
						<div class="h-100">
							<h5 class="mb-1"> <?= $data[0]->nama_sampah ?> </h5>
						</div>
					</div>
					</div>
					<div class="row">
					<div class="row">
						...
						<div class="card card-plain h-100">
							...
							<ul class="list-group">
								...
								<strong class="text-dark">Nama Sampah:</strong> &nbsp; <?= $data[0]->nama_sampah ?>
								</li>
								<li class="list-group-item border-0 ps-0 text-sm">
								<strong class="text-dark">Username:</strong> &nbsp; <?= $data[0]->nama_jenis_sampah ?>
								</li>
								<li class="list-group-item border-0 ps-0 text-sm">
								<strong class="text-dark">Harga:</strong> &nbsp; Rp<?= $data[0]->harga ?>
								</li>
							</ul>
							</div>
