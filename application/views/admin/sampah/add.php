													...
													<div class="row mt-3">
														<div class="col-12 col-sm-12 mt-3 mt-sm-0">
															<div class="input-group input-group-static">
																...
																<input required name="nama_sampah" placeholder="Nama Sampah" class="multisteps-form__input form-control" type="text" onfocus="focused(this)" onfocusout="defocused(this)"> 
															</div>
														</div>
													</div>
													<div class="row mt-3">
														...
														<div class="col-12 col-sm-6">
															<div class="input-group input-group-static">
																...
																<input required name="harga" placeholder="Harga" class="multisteps-form__input form-control" type="number" onfocus="focused(this)" onfocusout="defocused(this)"> 
															</div>
														</div>
													</div>
