    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Data Operator</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">Data Operator</h6>
          </nav>
      ...
      <div class="container-fluid py-4">
        <div class="d-sm-flex justify-content-between">
          <div>
            <a href="javascript:;" class="btn btn-icon bg-gradient-primary"> Tambah Operator </a>
          </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="font-weight-normal">
                        <span class="my-2 text-xs"><?= $data->username ?></span>
                      </td>
											<td class="font-weight-normal">
                        <span class="my-2 text-xs"><?= $data->nama ?></span>
                      </td>
											<td class="font-weight-normal">
                        <span class="my-2 text-xs"><?= $data->jenis_kelamin ?></span>
                      </td>
											<td class="font-weight-normal">
                        <span class="my-2 text-xs"><?= $data->tgl_lahir ?></span>
                      </td>
											<td class="font-weight-normal">
                        <span class="my-2 text-xs"><?= $data->no_telepon ?></span>
                      </td>
											<td class="font-weight-normal">
												<div class="dropdown">
